...
Markdown Table of Coding Challenge 1 dataset
-------------------------------
...
```{r import-clean}
cc1_data1 <- read.csv("A1_Data_Excel.csv")
...
```{r area-table, echo=FALSE, message=FALSE}
library(dplyr)
library(knitr)
...
![*Solanum pimpinellifolium*](./Solanum_pimpinellifolium_-_C_1.jpg)
